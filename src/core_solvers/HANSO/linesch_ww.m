function [alpha, xalpha, falpha, gradalpha, fail, beta, gradbeta, fevalrec, oracle] = ...
          linesch_ww(x0, f0, grad0, d, func_value, subgrad, c1, c2, fvalquit, prtlevel)
...
% minor correction in 2021: correcting a comment misspelling and
% changing the string linesch_ww_mod to linsech_ww in several places
...
if g0 >= 0
    ...
    fprintf('linesch_ww: WARNING, not a descent direction\n')
end
dnorm = norm(d);
if dnorm == 0
