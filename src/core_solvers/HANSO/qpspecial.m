...
% called by hanso, bfgs and gradsamp
% 2010: written by Anders Skajaa for HANSO version 2.0
% 2021: MLO modification for HANSO version 3.0, tightening some tolerances;
%   see string "MLO" in comments below.
% Call:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  HANSO 3.0 Copyright (C) 2010  Anders Skajaa and 2021 Michael Overton
...
mu0   = (x'*z) / n;           % first my
% MLO: instead of: tolmu = 1e-5;  
tolmu = 1e-12;                 % relative stopping tolerance, mu
% MLO: instead of: tolrs = 1e-5;                
tolrs = 1e-12;                 % and residual norm
